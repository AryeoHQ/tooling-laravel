...
trait ValidatesMethodsTestCases
{
    #[Test]
    ...
    #[Test]
    public function it_detects_a_method_via_class_reflection(): void
    {
        $reflection = $this->getClassReflection(ClassWithInterface::class);

        $this->assertTrue($this->hasMethod($reflection, 'classWithInterface'));
    }

    #[Test]
    public function it_detects_a_class_reflection_does_not_have_an_undefined_method(): void
    {
        $reflection = $this->getClassReflection(ClassWithInterface::class);

        $this->assertTrue($this->doesNotHaveMethod($reflection, 'nonExistentMethod'));
    }
}
