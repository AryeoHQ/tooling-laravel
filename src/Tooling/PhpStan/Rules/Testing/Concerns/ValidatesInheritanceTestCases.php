...
trait ValidatesInheritanceTestCases
{
    #[Test]
    ...
    #[Test]
    public function it_detects_inheritance_via_class_reflection(): void
    {
        $reflection = $this->getClassReflection(ClassWithInterface::class);

        $this->assertTrue($this->inherits($reflection, Contract::class));
    }

    #[Test]
    public function it_detects_non_inheritance_via_class_reflection(): void
    {
        $reflection = $this->getClassReflection(ClassWithInterface::class);
